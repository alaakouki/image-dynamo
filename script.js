...
const OPENAI_API_KEY = "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";
...
const generateAiImages = async (userPrompt, userImgQuantity) => {
    try {
        ...
        body: JSON.stringify({
            prompt: userPrompt,
            n: parseInt(userImgQuantity) // n should be intger
            ,
            size: "1024x1024",
        ...
        const {data} = await response.json(); // getting data from the response
        // console.log(data);
